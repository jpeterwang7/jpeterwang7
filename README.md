...
- 📤 Past projects
    ...
    + Conducted a randomized block experiment analyzing 200 synthetic participants with a two-way ANOVA to evaluate how alcohol type and dosage affect physical coordination
 
## Tools and Tech
- 🎒 I use
    + R (➕tidyverse, ggplot2, dplyr, pwr, car)
